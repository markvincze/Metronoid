...
void DirectXPage::InitializeComponent()
{
    ...
    // Get the TextBlock named 'txtFps'
    txtFps = safe_cast<Windows::UI::Xaml::Controls::TextBlock^>(static_cast<Windows::UI::Xaml::IFrameworkElement^>(this)->FindName(L"txtFps"));
